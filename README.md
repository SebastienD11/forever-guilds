...
The UI uses copy-paste [Warcraft CN](https://www.warcraftcn.com/docs) Button, Card, Input, Badge, and Textarea components plus their local frame assets. Their license is in `src/components/ui/warcraftcn/LICENSE.md`.
